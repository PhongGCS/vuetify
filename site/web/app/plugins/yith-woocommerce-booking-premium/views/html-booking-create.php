    ...
    <form method="POST">
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <p>
                        <input type="radio" id="yith-wcbk-no-order" name="order" value="no" class="checkbox" checked="checked"/>
                    ...
                    <p>
                        <input type="radio" id="yith-wcbk-assign-order" name="order" value="yes" class="checkbox"/>
