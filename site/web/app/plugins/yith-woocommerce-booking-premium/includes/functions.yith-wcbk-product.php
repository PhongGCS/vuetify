...
if ( !function_exists( 'yith_wcbk_product_metabox_form_field' ) ) {
    ...
    function yith_wcbk_product_metabox_form_field( $field ) {
        ...
        echo "<div class='yith-wcbk-form-field {$class}' {$data_html}>";
        echo "<label class='yith-wcbk-form-field__label' for='{$label_for}'>{$title}</label>";

        echo "<div class='yith-wcbk-form-field__container'>";
        yith_wcbk_print_fields( $fields );
        echo "</div>";

        if ( $desc ) {
            echo "<div class='yith-wcbk-form-field__description'>{$desc}</div>";
        }
