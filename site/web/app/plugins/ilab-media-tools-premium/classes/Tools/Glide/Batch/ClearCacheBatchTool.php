...
class ClearCacheBatchTool extends BatchTool {
    ...
    public static function BatchProcessClassName() {
        return "\\ILAB\\MediaCloud\\Tools\\Glide\\Batch\\ClearCacheBatchProcess";
    }
    ...
    public function instructionView() {
        return 'importer/instructions/clear-cache';
    }
    ...
    public function manualAction() {
        if (!isset($_POST['post_id'])) {
            BatchManager::instance()->setErrorMessage(static::BatchIdentifier(), 'Missing required post data.');
