<script type="text/html" id="tmpl-media-cloud-direct-upload">
    ...
    <div class="uploader-inline-content {{ messageClass }}">
        <# if ( data.message ) { #>
        <img class="media-cloud-upload-logo" src="<?php echo ILAB_PUB_IMG_URL.'/icon-cloud.svg'?>">
		...
		<?php else : ?>
            <div class="upload-ui">
                <img class="media-cloud-upload-logo" src="<?php echo ILAB_PUB_IMG_URL.'/icon-cloud.svg'?>">
                <h2 class="upload-instructions drop-instructions"><?php _e( 'Drop files anywhere to upload directly to '.\ILAB\MediaCloud\Storage\StorageManager::currentDriverName() ); ?></h2>
