...
new RADL( '__VUE_WORDPRESS__', 'vue_wordpress.js', array(
    ...
    'state' => array(
        ...
        'components' => RADL::callback( 'vue_wordpress_components' ),
...
function vue_wordpress_site()
{
    return array(
        ...
        'docTitle' => '',
        'loading' => false,
        'logo' => "/app/themes/cs-indotrek-com/public/img/logo-black.png",
...
function vue_wordpress_components() {
    return [
        "home_hero" => [
            "title" => "Where your Journey is the Destination",
            "image" => 'https://indotrek.conceptual.site/app/uploads/2020/02/Homepage-Hero-Girl_on_the_mountain-1-1440x768.jpg',
        ],
        "home_latest_new" => [
            "title" => "Latest New",
            "list" => [
                [
                    "title" => "Where your Journey is the Destination 1",
                    "image" => "https://indotrek.conceptual.site/app/uploads/2020/02/download-2.png",
                    "date" => date("F j Y"),
                    "description" => "Our top tips for keeping your footprint low in our beautiful countries"
                ],
                [
                    "title" => "Where your Journey is the Destination 2",
                    "image" => "https://indotrek.conceptual.site/app/uploads/2020/02/P8260606-scaled.jpg",
                    "date" => date("F j Y"),
                    "description" => "Our top tips for keeping your footprint low in our beautiful countries"
                ]
            ]
