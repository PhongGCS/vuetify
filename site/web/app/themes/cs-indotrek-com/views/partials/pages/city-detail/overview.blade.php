@php
   //vomit($content);
@endphp
@if ( !empty($content->gallery) && is_array($content->gallery) && count($content->gallery) )
<section class="section section--overview-single-destination">
    <div class="section__inner">
        <div class="grid grid-gap-xxxxs grid-gap-sm@sm">
            <div class="col-6@sm">
                ...
                <div class="to-animate">
                    <base-slider :items="{{ json_encode($content->gallery) }}" has-navigation has-pagination infinite-scroll auto-play>
                        <template v-slot:content="props">
                            <div class="position-relative" style="margin: 1px;">
                                <div class="crop crop--fit crop--3:2">
                                    <img class="crop__content crop__content--center" :src="props.data.image" :alt="props.data.title">
                                </div>
                                <div class="card__frame has-no-margin">
                                    <img src="@image('card-frame.svg')" alt="">
                                </div>
                            </div>
                            <div class="text-component text-center padding-x-xl">
                                <p v-html="props.data.description"></p>
                            </div>
                        </template>
