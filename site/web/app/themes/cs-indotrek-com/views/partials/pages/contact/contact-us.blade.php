            ...
            <div class="grid grid-gap-md">
                <div class="col-6@sm col-8@md">
                    <div id="intro-content">
                        <nav class="s-tabs">
                            <ul class="s-tabs__list">
                                <li><a href="{{get_permalink(CONTACT_ID)}}" class="s-tabs__item--selected">{{ get_the_title(CONTACT_ID) }}</a></li>
                                <li><a href="{{get_permalink(PRIVATE_TOUR_ID)}}" class="">{{ get_the_title(PRIVATE_TOUR_ID) }}</a></li>
                            </ul>
                        </nav>
                    ...
                    <base-form
                        ...
                        :form-items="{{ json_encode($content->getContactForm()) }}"
                    ...
                    <template #thank-you="props">
                        ...
                        <img class="margin-top-md" class="lazy" data-src="@image('thank-you-bike.jpg')" alt="{{ $themeSettings->forms->successfultitle }}">
                    </template>
                ...
                <div class="col-6@sm col-4@md">
                    <div class="card">
                        <div class="crop  crop--2:1">
                            <img class="crop__content crop__content--center lazy" data-src="{{ $themeSettings->contactBox->image }}" alt="">
                        </div>
